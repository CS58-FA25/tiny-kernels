...
/**
 * Description: Iterates over queue nodes and applies itemfunc to each node in the queue.
 * ========= Parameters ========
 * @param queue: A pointer to the queue to be iterated over.
 * @param arg: Arbitrary arg pointer passed to itemfunc.
 * @param itemfunc: Iterator function to be applied to each node.
 * ========= Returns =========
 * @return void
*/
...
/**
 * Description: Helper functionality for printing out queue contents.
 * =========== Parameters =========
 * @param queue: A pointer to the queue to be printed.
 * =========== Returns ========
 * @return void but prints out the contents of the given queue.
*/
